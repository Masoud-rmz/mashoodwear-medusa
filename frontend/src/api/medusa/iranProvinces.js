/**
 * Iran provinces for checkout select (mirrors Iran Pack provinces.ts).
 * purpose --- keep storefront province list aligned with validate-address ---
 */

/** @type {ReadonlyArray<{ code: string, en: string, fa: string }>} */
